package com.ragavan.randomusers.common
...
//this class extends livedata for providing response
// to its observer in realtime

class CheckingConnection(private val context: Context) : LiveData<Boolean>() {
